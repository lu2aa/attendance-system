      ...
      >
        <div className="mb-4">
          ...
          <p className="text-sm text-gray-500 mt-2">
            الملف يجب أن يحتوي على الأعمدة التالية: رقم الموظف، اسم الموظف، البريد
            الإلكتروني، المسمى الوظيفي، الدرجة، حالة العمل، إلخ
          </p>
          <a
            href="/templates/employees_template.xlsx"
